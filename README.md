...
- **Сравнение стран** — выбор нескольких стран и 30+ индикаторов (ВВП, инфляция, безработица, торговля, демография и др.), визуализация временных рядов через Chart.js (линейный, барный, scatter)
...
- **Распределение доходов** — кривые Лоренца, коэффициент Джини, тренды Gini по годам, рейтинг стран (один из наборов индикаторов)
...
│  - JWT-выдача        │  │  - Analytics (30+ индикаторов)│
│  - Интроспекция JWT  │◄─│  - Корреляция, Gini/Lorenz    │
...
│           ├── IncomeAnalysisPage.jsx # Анализ личных доходов и сбережений
